...
```{r density_plot}
line1 +
  geom_density(aes(x = age), fill = "purple", alpha = 0.3) +
  ggtitle("Density plot to show age distribution of customers")

``` 

```{r}
line1 +
  geom_density(aes(x = age, fill=marital_status), alpha = 0.3) +
  ggtitle("Density plot to show age distribution of customers")
